...
export default function App() {
  const { roomCode, reconnecting, displayPhase, streak } = useGame();
  const showStreak = roomCode && !reconnecting && displayPhase !== PHASES.LOBBY && streak > 1;
  ...
  return (
    <div className="app-shell">
      ...
      {showStreak ? <div className="streak-badge">🔥 Sequência do grupo: {streak}</div> : null}
